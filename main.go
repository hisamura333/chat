...
func main() {
	...
	gomniauth.WithProviders(
		...
		google.New("946952572246-2kfvdg0oru3ssdpd7t9pq88625rqo94k.apps.googleusercontent.com", "OfeYrDUUSZvD1WbzkpGD2Z551", "http://localhost:8080/auth/callback/google"),
